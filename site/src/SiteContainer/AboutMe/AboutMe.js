...
export default function AboutMe (props) {
    let fadeInScreenHandler = (screen) => {
        ...
        const SCREEN_CONSTANTS = {
            description: 'I am a seasoned Engineer experienced in building scalable applications & using OOP languages such as Node JS and Python alongside relational DBs. My current goal is to become a Software Engineer for Doctors Without Borders.',
            highlights: {
                bullets:[
